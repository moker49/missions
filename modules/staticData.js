...
export const staticData = [
    {
        ...
        perks: [
            ...
            { id: 'perk_a5', label: 'Re-roll enemy die', icons: perkData.perk_a5.icons, perkPoints: 3, effects: [{ proc: 'active' }] }
        ],
        missions: [
    ...
    },
    {
        ...
        perks: [
            ...
            { id: 'perk_b5', label: 'Add (Roll 1) to you attack', icons: perkData.perk_b5.icons, perkPoints: 3, effects: [{ proc: 'active' }] }
        ],
        missions: [
    ...
    },
    {
        ...
        perks: [
            ...
            { id: 'perk_c3', label: 'Sell and draw', icons: perkData.perk_c3.icons, perkPoints: 3, effects: [{ proc: 'gameStart' }] },
            { id: 'perk_c4', label: 'Momentum +2', icons: [perkData.momentum.icon], perkPoints: 2, effects: [{ statType: 'momentum', amount: 2 }] },
            { id: 'perk_c5', label: 'Your attack is undefendable', icons: perkData.perk_c5.icons, perkPoints: 4, effects: [{ proc: 'active' }] }
        ],
        missions: [
    ...
    },
    {
        ...
        perks: [
            ...
            { id: 'perk_d3', label: 'Free recruit', icons: perkData.perk_d3.icons, perkPoints: 3, effects: [{ proc: 'gameStart' }] },
            { id: 'perk_d4', label: 'Draw', icons: [perkData.draw.icon], perkPoints: 2, effects: [{ statType: 'draw', amount: 1 }] },
            { id: 'perk_d5', label: 'Reduce crisis clock advancement', icons: perkData.perk_d5.icons, perkPoints: 3, effects: [{ proc: 'active' }] }
        ],
        missions: [
    ...
    },
    {
        ...
        perks: [
            ...
            { id: 'perk_e5', label: 'Exhaust without discarding', icons: perkData.perk_e5.icons, perkPoints: 4, effects: [{ proc: 'active' }] }
        ],
        missions: [
